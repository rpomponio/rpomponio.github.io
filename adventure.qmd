...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle text-muted">Status: Soon to be published in ECP</h6>
  </div>
  <div class="card-body">
    <p class="card-text">
  ...
  <div class="card-body">
    <a href="https://docs.google.com/document/d/e/2PACX-1vTFO8GqQVoCU10lR2E1Ocz_hp44hjRcGlcHlnaIjlvh2jQZiIOnjuUzgeNmoLxqq_q4oPLmpkHaYjLg/pub" class="card-link">Link to Draft</a>
  </div>
